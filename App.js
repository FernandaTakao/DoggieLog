  ...
  return (
    <NavigationContainer> 
      <Stack.Navigator initialRouteName="home">
        ...
        <Stack.Screen name="singupTutor" component={SingupTutor} options={{ headerShown: false }}/>
        <Stack.Screen name="singupCaozinho" component={SingupCaozinho} options={{ headerShown: false }}/>
